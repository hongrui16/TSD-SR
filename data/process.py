...
def run_encode_prompt(data_dir):
    ...
    for hr_img_file in tqdm(hr_data_file, total=len(hr_data_file)):
        ...
        prompt_path = prompt_file.replace(".png",".pt").replace(hr_dir_name, prompt_embeds_dir_name)
        pool_path = prompt_file.replace(".png",".pt").replace(hr_dir_name, pool_prompt_embeds_dir_name)
